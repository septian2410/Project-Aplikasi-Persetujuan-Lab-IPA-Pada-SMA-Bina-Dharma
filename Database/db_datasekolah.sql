...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 01, 2022 at 08:12 AM
...
--
-- Table structure for table `tb_data_bayar_lain`
--
...
--
-- Dumping data for table `tb_data_bayar_lain`
--
...
--
-- Table structure for table `tb_data_bayar_spp`
--
...
--
-- Dumping data for table `tb_data_bayar_spp`
--
...
--
-- Table structure for table `tb_data_guru`
--
...
--
-- Dumping data for table `tb_data_guru`
--
...
--
-- Table structure for table `tb_data_kelas`
--
...
--
-- Dumping data for table `tb_data_kelas`
--
...
--
-- Table structure for table `tb_data_staff`
--
...
--
-- Dumping data for table `tb_data_staff`
--
...
--
-- Table structure for table `tb_in_barang`
--
...
--
-- Dumping data for table `tb_in_barang`
--
...
--
-- Table structure for table `tb_out_barang`
--
...
--
-- Dumping data for table `tb_out_barang`
--
...
--
-- Indexes for table `tb_data_bayar_lain`
--
...
--
-- Indexes for table `tb_data_bayar_spp`
--
...
--
-- Indexes for table `tb_data_guru`
--
ALTER TABLE `tb_data_guru`
  ADD PRIMARY KEY (`nip`);

--
-- Indexes for table `tb_data_kelas`
--
...
--
-- Indexes for table `tb_data_staff`
--
ALTER TABLE `tb_data_staff`
  ADD PRIMARY KEY (`id_staff`);

--
-- Indexes for table `tb_in_barang`
--
...
--
-- Indexes for table `tb_out_barang`
--
...
--
-- AUTO_INCREMENT for table `tb_data_kelas`
--
ALTER TABLE `tb_data_kelas`
